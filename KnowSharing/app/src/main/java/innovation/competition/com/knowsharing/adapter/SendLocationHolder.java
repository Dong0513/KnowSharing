...
public class SendLocationHolder extends BaseViewHolder {
  ...
  public SendLocationHolder(Context context, ViewGroup root, BmobIMConversation c, OnRecyclerViewListener onRecyclerViewListener) {
    ...
    iv_fail_resend = root.findViewById(R.id.iv_fail_resend);
    tv_time = root.findViewById(R.id.tv_time);
    layout_location = root.findViewById(R.id.layout_location);
    tv_location = root.findViewById(R.id.tv_location);
    tv_send_status = root.findViewById(R.id.tv_send_status);
    progress_load = root.findViewById(R.id.progress_load);
  }
